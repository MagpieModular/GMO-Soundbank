...
#include <samples/Wavetables/ambiplop_int8.h> // Table for Sample
#include <samples/Wavetables/hallow_int8.h> // Table for Sample 
#include <samples/Wavetables/plastic_int8.h> // Table for Sample 
#include <samples/Wavetables/snare2_int8.h> // Table for Sample 
#include <samples/Wavetables/snarez_int8.h> // Table for Sample 
#include <samples/Wavetables/water_int8.h> // Table for Sample
#include <samples/Wavetables/glurps_int8.h> // Table for Sample 
#include <samples/Wavetables/bitz1_int8.h> // Table for Sample

#define CONTROL_RATE 256 // powers of 2 please 

Sample <AMBIPLOP_NUM_CELLS, AUDIO_RATE> aSample(AMBIPLOP_DATA); // create the wavetable template 
...
*/
  ...
  */
  ...
  switch (sampleSelect) {
    case 1:
      aSample.setTable(AMBIPLOP_DATA); // change the current wavetable
      CURRENT_TABLE = AMBIPLOP_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 2:
      aSample.setTable(HALLOW_DATA); // change the current wavetable
      CURRENT_TABLE = HALLOW_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 3:
      aSample.setTable(PLASTIC_DATA); // change the current wavetable
      CURRENT_TABLE = PLASTIC_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 4:
      aSample.setTable(SNARE2_DATA); // change the current wavetable
      CURRENT_TABLE = SNARE2_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 5:
      aSample.setTable(SNAREZ_DATA); // change the current wavetable
      CURRENT_TABLE = SNAREZ_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 6:
      aSample.setTable(WATER_DATA); // change the current wavetable
      CURRENT_TABLE = WATER_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 7:
      aSample.setTable(GLURPS_DATA); // change the current wavetable
      CURRENT_TABLE = GLURPS_NUM_CELLS; // set the wavetable length to current wavetable
      break;

    case 8:
      aSample.setTable(BITZ1_DATA); // change the current wavetable
      CURRENT_TABLE = BITZ1_NUM_CELLS; // set the wavetable length to current wavetable
      break;
  }
